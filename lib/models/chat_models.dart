...
class ChatMessage {
  ...
  factory ChatMessage.fromJson(Map<String, dynamic> json) => ChatMessage(
    ...
    attachments: ((json['attachments'] as List?) ?? const [])
        .map(
          (e) => ChatAttachment.fromJson(Map<String, dynamic>.from(e as Map)),
        )
        .toList(),
    reasoning: (json['reasoning'] as String?) ?? '',
    toolCalls: ((json['toolCalls'] as List?) ?? const [])
        .map(
          (e) => ToolCallRecord.fromJson(Map<String, dynamic>.from(e as Map)),
        )
        .toList(),
    ...
    sources: ((json['sources'] as List?) ?? const [])
        .map((e) => SourceRecord.fromJson(Map<String, dynamic>.from(e as Map)))
        .toList(),
