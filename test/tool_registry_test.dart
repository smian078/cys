...
void main() {
  test('validates and accepts typed arguments', () {
    final r = ToolRegistry()..register(DemoTool());
    expect(
      r.validateInvocation('demo', '{"message":"hello"}')['message'],
      'hello',
    );
  });
  ...
  test('rejects malformed json', () {
    final r = ToolRegistry()..register(DemoTool());
    expect(
      () => r.validateInvocation('demo', '{oops'),
      throwsA(isA<ToolValidationException>()),
    );
  });
}
